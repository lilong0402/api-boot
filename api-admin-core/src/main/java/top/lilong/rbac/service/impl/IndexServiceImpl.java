...
public class IndexServiceImpl implements IndexService {
 ...
 public Map<String, List<LabelVO>> statistics3() {
  List<LabelVO> goods = List.of(new LabelVO("审核中",5),new LabelVO("销售中",17),new LabelVO("已下架",5),new LabelVO("库存预警",2));
  List<LabelVO> orders = List.of(new LabelVO("待付款",24),new LabelVO("代发货",65),new LabelVO("已发货",89),new LabelVO("退款中",2));
